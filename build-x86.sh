...
sed -i "s/CONFIG_DEFAULT_TARGET_OPTIMIZATION=\"-Os -pipe\"/CONFIG_DEFAULT_TARGET_OPTIMIZATION=\"-O2 -pipe -march=x86-64-v2\"/g" .config
sed -i "s/CONFIG_TARGET_OPTIMIZATION=\"-Os -pipe\"/CONFIG_TARGET_OPTIMIZATION=\"-O2 -pipe -march=x86-64-v2\"/g" .config
# sed -i "s/CONFIG_CPU_TYPE=\" \"/CONFIG_CPU_TYPE=\"corei7\"/g" .config
# sed -i "s/-Os -pipe/-O2 -pipe/g" .config
